...
| **MicroPython (ESP32)** | [`microTRS-80/`](microTRS-80/) | Copy files to the board; see [board setup](microTRS-80/README.md) |
...
| File / Folder | Purpose |
|---------------|---------|
| `TRS80_July_27_26.py` | **Python simulator** — interpreter, Tkinter UI, screen, debugger (~4,300 lines) |
