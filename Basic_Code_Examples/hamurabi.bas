1 REM HAMURABI - DAVID AHL, BASIC COMPUTER GAMES (CREATIVE COMPUTING, 1978)
2 REM TRS-80 LEVEL II BASIC (MODEL I / III). SOURCE: CORRANWEBSTER.COM/HAMURABI/HAMURABI.BAS
3 REM LEVEL II: RND(1) REPLACED BY RND(0) FOR RANDOM FLOAT IN [0,1) PER TRS-80 MANUAL
4 CLS
5 PRINT "       *** HAMURABI ***"
6 PRINT "  CREATIVE COMPUTING / DAVID AHL"
7 PRINT
8 PRINT "  RULE SUMERIA FOR 10 YEARS."
9 PRINT "  EACH YEAR YOU DECIDE:"
10 PRINT "    1) BUY OR SELL LAND (BUSHELS/ACRE)"
11 PRINT "    2) FEED THE PEOPLE"
12 PRINT "    3) PLANT ACRES WITH SEED"
13 PRINT
14 PRINT "  RULES OF THUMB:"
15 PRINT "    FEED: 20 BUSHELS PER PERSON"
16 PRINT "          (LESS -> STARVATION)"
17 PRINT "    PLANT: 1/2 BUSHEL SEED PER ACRE"
18 PRINT "           MAX 10 ACRES PER PERSON"
19 PRINT "    KEEP A GRAIN RESERVE FOR BAD YEARS"
20 PRINT
21 PRINT "  NEGATIVE ANSWERS END YOUR TERM."
22 PRINT
23 PRINT "  PRESS ANY KEY TO START"
24 IF INKEY$="" THEN 24
25 CLS
26 PRINT TAB(32);"HAMURABI"
27 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
28 PRINT:PRINT:PRINT
29 PRINT "TRY YOUR HAND AT GOVERNING ANCIENT SUMERIA"
30 PRINT "FOR A TEN-YEAR TERM OF OFFICE.":PRINT
95 D1=0: P1=0
...
965 PRINT "REALLY WASN'T TOO BAD AT ALL. ";INT(P*.8*RND(0));"PEOPLE"
