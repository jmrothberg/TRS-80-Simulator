...
150 LET SC = 0
160 LET LV = 3    
170 LET SP = 100000 : REM FRAME DELAY, THE ONLY LINE THAT DIFFERS FROM THE JMR COPY, WHICH USES 1
...
1810 FOR I = 1 TO 4
1820 FOR J = 1 TO 5
1830 IF BK((I-1)*15+J) = 1 THEN SET(J+28+(I-1)*24, 44) : REM ROWS 44-42, EACH ONE UP
1840 NEXT J
1850 FOR J = 6 TO 10
1860 IF BK((I-1)*15+J) = 1 THEN SET(J+23+(I-1)*24, 43)
1870 NEXT J
1880 FOR J = 11 TO 15
1890 IF BK((I-1)*15+J) = 1 THEN SET(J+18+(I-1)*24, 42)
1900 NEXT J
1910 NEXT I
1920 RETURN
...
3110 IF (E(I) - 128 * INT(E(I) / 128)) = 0 OR (E(I) - 128 * INT(E(I) / 128)) = 122 THEN GOSUB 3200 : REM 122 NOT 127 BECAUSE THE INVADER IS 6 WIDE
3120 RETURN
...
7000 REM RESPAWN ENEMIES (FOR uses N: I is enemy loop at 4010 when GOSUB from 5250)
7010 FOR N = 1 TO 15
7020 LET R = INT((N-1)/ 5)
7030 LET C = N - 1 - (R * 5)
7040 LET E(N) =  R * 1024 + (C * 24) + 1
7050 NEXT N
7060 RETURN
