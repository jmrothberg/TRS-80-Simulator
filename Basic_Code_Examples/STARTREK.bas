...
15 REM TRS-80 MODEL I LEVEL II BASIC PORT
30 REM
40 REM ****  **** STAR TREK ****  ****
...
212 REM *** MICROSOFT RND(1) IS A FRACTION; LEVEL II RND(1) IS THE CONSTANT
213 REM *** 1 AND ONLY RND(0) IS A FRACTION, SO EVERY CALL IS NOW RND(0)
215 REM
...
1280 PRINT:PRINT "HIT RETURN TO ACKNOWLEDGE YOUR ORDERS ";
1290 INPUT I1$
1300 I=RND(0)
...
1600 FOR I=1 TO 3:K(I,3)=0:NEXT I:Q$=Z$+Z$+Z$+Z$+Z$+Z$+Z$+Z$
...
2060 PRINT"COMMAND";
2061 INPUT A$
2062 IF LEFT$(A$,4)="HELP" OR A$="?" THEN GOSUB 9300:GOTO 1990
2080 FOR I=1 TO 9:IF LEFT$(A$,3)<>MID$(A1$,3*I-2,3) THEN 2160
2140 ON I GOTO 2290,1980,4000,4260,4700,5530,5690,7290,6270
...
2255 PRINT" HELP (FOR COMPLETE INSTRUCTIONS)"
2260 PRINT" XXX (TO RESIGN YOUR COMMAND)":PRINT:GOTO 1990
2290 REM COURSE CONTROL BEGINS HERE
2300 PRINT"COURSE (1-8)";
2301 INPUT C1:IF C1=9 THEN C1=1
...
2840 R1=I:GOSUB 8790
2841 PRINT TAB(8);G2$;" REPAIR COMPLETED."
...
4230 NEXT L:PRINT":":PRINT O1$:NEXT I
4232 PRINT "  4 3 2"
4234 PRINT "  5 * 1"
4236 PRINT "  6 7 8"
4240 GOTO 1990
...
4760 PRINT"PHOTON TORPEDO COURSE (1-8)";
4761 INPUT C1:IF C1=9 THEN C1=1
...
5561 PRINT"NUMBER OF UNITS TO SHIELDS";
5562 INPUT X
...
5840 PRINT"WILL YOU AUTHORIZE THE REPAIR ORDER (Y/N)";
5841 INPUT A$
...
6060 H=INT((K(I,3)/FND(1))*(2+RND(0)))
6061 S=S-H
...
6400 IF T=T0 THEN 6402
6401 PRINT"YOUR EFFICIENCY RATING IS";1000*(K7/(T-T0))^2:GOTO 6290
6402 PRINT"YOUR EFFICIENCY RATING IS";0:GOTO 6290
...
6660 C$="GREEN":IF E<1000 THEN C$="YELLOW"
6720 IF D(2)<0 THEN PRINT:PRINT"*** SHORT RANGE SENSORS ARE OUT ***":PRINT:RETURN
6770 PRINT"   1   2   3   4   5   6   7   8"
6775 O1$="---------------------------------":PRINT O1$
6780 FOR I=1 TO 8
6790 PRINT MID$(STR$(I),2);
...
8171 PRINT" INITIAL COORDINATES (X,Y)";
8172 INPUT C1,A
...
9300 REM COMPLETE HELP SYSTEM
9310 PRINT:PRINT"HELP - PAGE 1 OF 5"
9320 PRINT"MISSION: DESTROY ALL KLINGON SHIPS BEFORE TIME RUNS OUT."
9330 PRINT"YOU HAVE ENERGY, SHIELDS, TORPEDOES, AND STARBASES."
9340 PRINT"COMMANDS: NAV SRS LRS PHA TOR SHE DAM COM XXX HELP"
9350 PRINT"PRESS ENTER TO CONTINUE";
9360 INPUT A$
9370 PRINT:PRINT"HELP - PAGE 2 OF 5"
9380 PRINT"LRS = LONG RANGE SCAN OF THE 3X3 QUADRANTS AROUND YOU."
9390 PRINT"EACH 3-DIGIT NUMBER IS:"
9400 PRINT" HUNDREDS = KLINGONS"
9410 PRINT" TENS     = STARBASES"
9420 PRINT" ONES     = STARS"
9430 PRINT"EXAMPLE: 106 = 1 KLINGON, 0 STARBASES, 6 STARS."
9440 PRINT"PRESS ENTER TO CONTINUE";
9450 INPUT A$
9460 PRINT:PRINT"HELP - PAGE 3 OF 5"
9470 PRINT"SRS = SHORT RANGE SCAN OF YOUR CURRENT 8X8 QUADRANT."
9480 PRINT"SYMBOLS:"
9490 PRINT" <*> = ENTERPRISE"
9500 PRINT" +K+ = KLINGON"
9510 PRINT" >!< = STARBASE"
9520 PRINT"  *  = STAR"
9530 PRINT
9540 PRINT"IF YOU MOVE NEXT TO A STARBASE, YOU DOCK AND RESUPPLY."
9550 PRINT"PRESS ENTER TO CONTINUE";
9560 INPUT A$
9570 PRINT:PRINT"HELP - PAGE 4 OF 5"
9580 PRINT"DIRECTIONS USE THE COMPASS PATTERN:"
9590 PRINT"  4 3 2"
9600 PRINT"  5 * 1"
9610 PRINT"  6 7 8"
9620 PRINT"1=RIGHT  3=UP  5=LEFT  7=DOWN"
9630 PRINT"2,4,6,8 ARE DIAGONALS. 9 MEANS 1."
9640 PRINT"WARP FACTOR SETS DISTANCE. .1 FOR ONE SECTOR."
9645 PRINT"HIGHER WARP USES MORE ENERGY."
9650 PRINT"PRESS ENTER TO CONTINUE";
9660 INPUT A$
9670 PRINT:PRINT"HELP - PAGE 5 OF 5"
9680 PRINT"PHASERS SPLIT ENERGY ACROSS KLINGONS."
9690 PRINT"TORPEDOES TRAVEL IN A STRAIGHT LINE UNTIL THEY HIT."
9700 PRINT"RED CONDITION = KLINGONS IN YOUR QUADRANT."
9710 PRINT"DOCKING DROPS SHIELDS AND REPAIRS/REFUELS YOUR SHIP."
9720 PRINT"USE LRS TO PLAN, SRS TO FIGHT, AND WATCH THE STARDATE."
9730 PRINT"PRESS ENTER TO RETURN TO THE GAME";
9740 INPUT A$
9750 RETURN
